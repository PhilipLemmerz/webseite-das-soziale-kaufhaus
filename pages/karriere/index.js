                ...
                <div className={styles.workOfferWrapper}>
                    <div className={styles.workOfferBox}>
                        ...
                        <ul className={styles.list}>
                            ...
                            <li>Inserieren von Möbeln auf den gängigen Kleinanzeigen-Plattformen</li>
                        </ul>
                        ...
                        <ul className={styles.list}>
                            ...
                            <li>Sie sind vertraut im Umgang mit Computern</li>
                        </ul>
                        <p>
                            ...
                            Für Rückfragen steht Ihnen Herr Lemmerz gerne telefonisch unter 0151-11 4444 70 zur Verfügung.
                        </p>
